                ...
                <div class="input-style">
                    <div class="align-center">
                        <div class="inputField" id="borderEmri">
                            ...
                            <input type="text" id="emri" name = "emri" onclick='removeError("errorEmri", "borderEmri")'
                                placeholder="Emri">
                        </div>
                ...
                <div class="input-style">
                    <div class="align-center">
                        <div class="inputField" id="borderEmail">
                            ...
                            <input type="email" id="email" name = "email" onclick='removeError("errorEmail","borderEmail")'
                    ...
                    <div class="align-center">
                        <div class="inputField" id="borderUsername">
                            ...
                            <input type="text" id="username" name = "username" onclick='removeError("errorUsername", "borderUsername")'
                ...
                <div class="input-style">
                    <div class="align-center">
                        <div class="inputField" id="borderpw1">
                            ...
                            <input type="password" id="pw1" name = "password" onclick='removeError("errorPassword", "borderpw1")'
